...
<div class="row">
    <div class="col">
        <form class="form-horizontal form-bordered" id="form_cadastre" method="post"
            ...
            <input type="hidden" name="announcement_type" value="2" />
            <section class="card">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <select name="categories[]" multiple data-plugin-selectTwo
                                        ...
                                        @if (isset($entity->id) and (count($category->contents)>0))
...
<section class="card">
    <header class="card-header">
        ...
        <h2 class="card-title">Dados para compra</h2>
    </header>
    <div class="card-body" style="display: block;">
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group row">
                    {{--  <div class="col-lg-12" style="margin-bottom: 15px">
                        <p class="card-subtitle">Se caso o valor do produto estiver com o valor zerado ou vazio, na
                            pagina do site, apresentará a mensagem "Valor a Consultar"</p>
                        <div class="input-group">
                            <span class="input-group-prepend">
                                <span class="input-group-text">
                            ...
                            <input value="{{ isset($entity->price)!=""?$entity->price:'' }}" type="text" name="price"
                    class="form-control money" placeholder="Valor" required>
                </div>
            </div> --}}
            <div class="col-lg-12" style="margin-bottom: 15px">
                <p class="card-subtitle">Digite uma breve descrição do produto</p>
                <textarea name="short_description"
                    class="form-control">{{ isset($entity->short_description)?$entity->short_description:'' }}</textarea>
            </div>
            <div class="col-lg-12" style="margin-bottom: 15px">
                <p class="card-subtitle">Este e-mail, é o e-mail de quem fez o anúncio.</p>
                <div class="input-group">
                    <span class="input-group-prepend">
                        <span class="input-group-text">
                    ...
                    <input value="{{ isset($entity->email)!=""?$entity->email:'' }}" type="email" name="email"
                        class="form-control" placeholder="E-mail" required>
                </div>
            </div>
            <div class="col-lg-12" style="margin-bottom: 15px">
                <p class="card-subtitle">Telefone do prestador de serviço</p>
                <div class="input-group">
                    <span class="input-group-prepend">
                        <span class="input-group-text">
                    ...
                    <input value="{{ isset($entity->phone)!=""?$entity->phone:'' }}" type="text" name="phone"
                        class="form-control phone" placeholder="Telefone de Contato" required>
                </div>
            </div>
        </div>
    </div>
...
<section class="card">
    <header class="card-header">
        ...
        <h2 class="card-title">Descrição completa</h2>
        <p class="card-subtitle">
            Preencha com as informações e descrições completas do produto.
        </p>
    </header>
    <div class="card-body" style="display: block;">
        <div class="form-group row">
...
<section class="card">
    ...
    <div class="card-body" style="display: block;">
        <div class="row">
            <div class="col-lg-12">
                <small>Tamanho da imagem 1000px x 1000px</small>
                <div class="fileupload fileupload-new" data-provides="fileupload">
                    <div class="input-append">
                        ...
                        <span class="btn btn-default btn-file">
                            ...
                            <input type="file" name='banner' accept="image/*" onchange='loadPreview(this, 1000,1000)'
